...
$expectedRole = "Langkay Leader/Assistant";
...
<html lang="en">
  <head>
    ...
    <title>Langkay Leader Home • BSP</title>
    <link rel="stylesheet" href="../../public/css/styles.css" />
  </head>
  <body>
    <div class="container">
      <section class="hero">
        <h1>Langkay Leader/Assistant</h1>
      ...
      <section class="card">
        ...
        <p>You are approved for the Langkay Leader/Assistant role.</p>
