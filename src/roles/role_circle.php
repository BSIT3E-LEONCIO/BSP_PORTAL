...
$expectedRole = "Circle Manager/Assistant";
...
<html lang="en">
  <head>
    ...
    <title>Circle Manager Home • BSP</title>
    <link rel="stylesheet" href="../../public/css/styles.css" />
  </head>
  <body>
    <div class="container">
      <section class="hero">
        <h1>Circle Manager/Assistant</h1>
      ...
      <section class="card">
        ...
        <p>You are approved for the Circle Manager/Assistant role.</p>
