...
$expectedRole = "District/Municipal Commissioner/Coordinator/Member-at-Large";
...
<html lang="en">
  <head>
    ...
    <title>District/Municipal Home • BSP</title>
    <link rel="stylesheet" href="../../public/css/styles.css" />
  </head>
  <body>
    <div class="container">
      <section class="hero">
        <h1>District/Municipal Commissioner/Coordinator/Member-at-Large</h1>
      ...
      <section class="card">
        ...
        <p>You are approved for the District/Municipal Commissioner/Coordinator/Member-at-Large role.</p>
