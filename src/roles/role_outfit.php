...
$expectedRole = "Outfit Leader/Assistant";
...
<html lang="en">
  <head>
    ...
    <title>Outfit Leader Home • BSP</title>
    <link rel="stylesheet" href="../../public/css/styles.css" />
  </head>
  <body>
    <div class="container">
      <section class="hero">
        <h1>Outfit Leader/Assistant</h1>
      ...
      <section class="card">
        ...
        <p>You are approved for the Outfit Leader/Assistant role.</p>
