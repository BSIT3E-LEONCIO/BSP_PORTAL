...
$expectedRole = "Troop Leader/Assistant";
...
<html lang="en">
  <head>
    ...
    <title>Troop Leader Home • BSP</title>
    <link rel="stylesheet" href="../../public/css/styles.css" />
  </head>
  <body>
    <div class="container">
      <section class="hero">
        <h1>Troop Leader/Assistant</h1>
      ...
      <section class="card">
        ...
        <p>You are approved for the Troop Leader/Assistant role.</p>
