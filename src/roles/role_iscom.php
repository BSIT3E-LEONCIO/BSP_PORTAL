...
$expectedRole = "Institutional Scouting Representative/ISCOM/ISC";
...
<html lang="en">
  <head>
    ...
    <title>Institutional Scouting Home • BSP</title>
    <link rel="stylesheet" href="../../public/css/styles.css" />
  </head>
  <body>
    <div class="container">
      <section class="hero">
        <h1>Institutional Scouting Representative/ISCOM/ISC</h1>
      ...
      <section class="card">
        ...
        <p>You are approved for the Institutional Scouting Representative/ISCOM/ISC role.</p>
